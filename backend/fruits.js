...
// Sample insertion (commented out to avoid accidental execution)
// Uncomment these to insert sample data if needed

// Fruit.insertMany([
//   { name: 'Dragon', img: 'https://images.pexels.com/photos/18916473/pexels-photo-18916473/free-photo-of-dragon-fruit-on-hot-pink-background.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', description: 'Good for health', price: `₹${(Math.random() * 100 + 10).toFixed(2)}` }
// ]);
...
module.exports = { Fruit, Vegetable, Cart };
